...
export const ROLES: StaticRole[] = [
  ...
  { name: 'Sales', displayName: 'Sales', permissions: ['Samples.Manage', 'Samples.Notes', 'Customer.View', 'Customers.Manage', 'Sales.View', 'Orders.Approve', 'Orders.Delete', 'Plan.View'] },
